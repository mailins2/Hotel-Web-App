      ...
      <div class="container">
        <div class="row no-gutters slider-text d-flex align-itemd-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center d-flex align-items-end justify-content-center">
          	<div class="text">
	            <p class="breadcrumbs mb-2"><span class="mr-2"><a href="{{ route('customer.home') }}">Home</a></span> <span>About Us</span></p>
      ...
      <div class="container-fluid">
        ...
        <div class="row no-gutters">
          <div class="col-sm-12 col-md ftco-animate">
            <a href="{{ Vite::asset('resources/customer/images/insta-1.jpg') }}" class="insta-img image-popup" data-bg-image="{{ Vite::asset('resources/customer/images/insta-1.jpg') }}">
          ...
          <div class="col-sm-12 col-md ftco-animate">
            <a href="{{ Vite::asset('resources/customer/images/insta-2.jpg') }}" class="insta-img image-popup" data-bg-image="{{ Vite::asset('resources/customer/images/insta-2.jpg') }}">
              <div class="icon d-flex justify-content-center">
                <span class="icon-instagram align-self-center"></span>
              </div>
            </a>
          ...
          <div class="col-sm-12 col-md ftco-animate">
            <a href="{{ Vite::asset('resources/customer/images/insta-3.jpg') }}" class="insta-img image-popup" data-bg-image="{{ Vite::asset('resources/customer/images/insta-3.jpg') }}">
              <div class="icon d-flex justify-content-center">
                <span class="icon-instagram align-self-center"></span>
              </div>
            </a>
          ...
          <div class="col-sm-12 col-md ftco-animate">
            <a href="{{ Vite::asset('resources/customer/images/insta-4.jpg') }}" class="insta-img image-popup" data-bg-image="{{ Vite::asset('resources/customer/images/insta-4.jpg') }}">
              <div class="icon d-flex justify-content-center">
                <span class="icon-instagram align-self-center"></span>
              </div>
            </a>
          ...
          <div class="col-sm-12 col-md ftco-animate">
            <a href="{{ Vite::asset('resources/customer/images/insta-5.jpg') }}" class="insta-img image-popup" data-bg-image="{{ Vite::asset('resources/customer/images/insta-5.jpg') }}">
              <div class="icon d-flex justify-content-center">
                <span class="icon-instagram align-self-center"></span>
              </div>
            </a>
