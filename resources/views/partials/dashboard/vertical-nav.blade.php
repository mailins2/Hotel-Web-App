<ul class="navbar-nav iq-main-menu"  id="sidebar">
    ...
    <li class="nav-item">
     ...
     <li class="nav-item static-item">
      ...
      <li class="nav-item">
        <a class="nav-link {{ request()->is('hotel/accounts*') ? 'active' : '' }}" href="{{ route('hotel.accounts.index') }}">
            <i class="icon">
                <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <li class="nav-item">
        <a class="nav-link {{ request()->is('hotel/customers*') ? 'active' : '' }}" href="{{ route('hotel.customers.index') }}">
            <i class="icon">
                <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <li class="nav-item">
        <a class="nav-link {{ request()->is('hotel/employees*') ? 'active' : '' }}" href="{{ route('hotel.employees.index') }}">
            <i class="icon">
                <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <li class="nav-item">
     ...
     <li class="nav-item">
        <a class="nav-link {{ request()->is('hotel/bookings*') ? 'active' : '' }}" href="{{ route('hotel.bookings.index') }}">
            <i class="icon">
                <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path opacity="0.4" d="M7 4C5.89543 4 5 4.89543 5 6V18C5 19.1046 5.89543 20 7 20H17C18.1046 20 19 19.1046 19 18V9.41421C19 8.88378 18.7893 8.37507 18.4142 8L15 4.58579C14.6249 4.21071 14.1162 4 13.5858 4H7Z" fill="currentColor"></path>
                    <path d="M14 4.5V8C14 8.55228 14.4477 9 15 9H18.5" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"></path>
                    <path d="M8 12H16" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"></path>
                    <path d="M8 15.5H13.5" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"></path>
                </svg>
            </i>
            <span class="item-name">Danh sách đặt phòng</span>
        </a>
    </li>

    <li class="nav-item">
        <a class="nav-link {{ request()->is('hotel/services*') ? 'active' : '' }}" href="{{ route('hotel.services.index') }}">
            <i class="icon">
                <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <li class="nav-item">
        <a class="nav-link {{ request()->is('hotel/promotions*') ? 'active' : '' }}" href="{{ route('hotel.promotions.index') }}">
            <i class="icon">
                <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <li class="nav-item">
        <a class="nav-link {{ request()->is('hotel/invoices*') ? 'active' : '' }}" href="{{ route('hotel.invoices.index') }}">
            <i class="icon">
                <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <li class="nav-item">
        <a class="nav-link {{ request()->is('hotel/payments*') ? 'active' : '' }}" href="{{ route('hotel.payments.index') }}">
            <i class="icon">
                <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <li class="nav-item">
        <a class="nav-link {{ request()->is('hotel/reviews*') ? 'active' : '' }}" href="{{ route('hotel.reviews.index') }}">
            <i class="icon">
                <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
