            ...
            <div class="card">
                <div class="card-header d-flex flex-wrap justify-content-between align-items-center gap-2 pb-4">
                    <div class="header-title">
                        <h4 class="card-title mb-1">Dịch vụ phòng</h4>
                        <p class="mb-0 text-muted">Danh sách dịch vụ hỗ trợ trực tiếp trong thời gian khách lưu trú.</p>
                    </div>
                ...
                <div class="card-body">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="hm-select-wrap">
                                            <select class="form-select">
                                                ...
                                                <option selected>Dịch vụ phòng</option>
                    ...
                    <div class="mb-4">
                        <div class="d-flex flex-wrap align-items-center gap-2">
                            ...
                            <a href="{{ route('hotel.services.room-service') }}" class="btn btn-sm btn-primary" style="padding: 8px 14px;">Dịch vụ phòng</a>
                    ...
                    <div class="row g-3 mb-4">
                        ...
                        <div class="col-md-6 col-xl-4">
                            <div class="hm-service-card">
                                <div class="fw-semibold">Bổ sung minibar</div>
                                <div class="small text-muted mt-1">80.000 VNĐ</div>
                                <div class="mt-3">
                                    <div class="d-flex align-items-center justify-content-center rounded border bg-light text-muted" style="height: 160px; border-style: dashed !important;">
                                        Khu vực ảnh dịch vụ
                                    </div>
                        ...
                        <table class="table table-striped align-middle">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>120.000 VNĐ</td>
                                    <td>Dịch vụ phòng</td>
                                    <td>@include('hotel-management.partials.action-icons', ['showUrl' => route('hotel.services.show', ['recordId' => 6]), 'editUrl' => route('hotel.services.edit', ['recordId' => 6]), 'showDelete' => true])</td>
                                </tr>
                                <tr>
                                    <td>7</td>
                                    <td>Vệ sinh</td>
                                    <td>90.000 VNĐ</td>
                                    <td>Dịch vụ phòng</td>
                                    <td>@include('hotel-management.partials.action-icons', ['showUrl' => route('hotel.services.show', ['recordId' => 7]), 'editUrl' => route('hotel.services.edit', ['recordId' => 7]), 'showDelete' => true])</td>
                                </tr>
                                <tr>
                                    <td>10</td>
                                    <td>Bổ sung minibar</td>
                                    <td>80.000 VNĐ</td>
                                    <td>Dịch vụ phòng</td>
                                    <td>@include('hotel-management.partials.action-icons', ['showUrl' => route('hotel.services.show', ['recordId' => 10]), 'editUrl' => route('hotel.services.edit', ['recordId' => 10]), 'showDelete' => true])</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
