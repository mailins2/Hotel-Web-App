            ...
            <div class="card">
                <div class="card-header d-flex flex-wrap justify-content-between align-items-center gap-2 pb-4">
                    <div class="header-title">
                        <h4 class="card-title mb-1">Dịch vụ ăn uống</h4>
                        <p class="mb-0 text-muted">Danh sách dịch vụ ăn uống đang phục vụ tại khách sạn.</p>
                    </div>
                ...
                <div class="card-body">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="hm-select-wrap">
                                            <select class="form-select">
                                                ...
                                                <option selected>Dịch vụ ăn uống</option>
                    ...
                    <div class="mb-4">
                        <div class="d-flex flex-wrap align-items-center gap-2">
                            ...
                            <a href="{{ route('hotel.services.food-and-beverage') }}" class="btn btn-sm btn-primary" style="padding: 8px 14px;">Dịch vụ ăn uống</a>
                    ...
                    <div class="row g-3 mb-4">
                        ...
                        <div class="col-md-6 col-xl-4">
                            <div class="hm-service-card">
                                <div class="fw-semibold">Nước trái cây</div>
                                <div class="small text-muted mt-1">45.000 VNĐ</div>
                                <div class="mt-3">
                                    <div class="d-flex align-items-center justify-content-center rounded border bg-light text-muted" style="height: 160px; border-style: dashed !important;">
                                        Khu vực ảnh dịch vụ
                                    </div>
                        ...
                        <table class="table table-striped align-middle">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>@include('hotel-management.partials.action-icons', ['showUrl' => route('hotel.services.show', ['recordId' => 1]), 'editUrl' => route('hotel.services.edit', ['recordId' => 1]), 'showDelete' => true])</td>
                                </tr>
                                <tr>
                                    <td>2</td>
                                    <td>Cơm chiên</td>
                                    <td>60.000 VNĐ</td>
                                    <td>Dịch vụ ăn uống</td>
                                    <td>@include('hotel-management.partials.action-icons', ['showUrl' => route('hotel.services.show', ['recordId' => 2]), 'editUrl' => route('hotel.services.edit', ['recordId' => 2]), 'showDelete' => true])</td>
                                </tr>
                                <tr>
                                    <td>3</td>
                                    <td>Nước trái cây</td>
                                    <td>45.000 VNĐ</td>
                                    <td>Dịch vụ ăn uống</td>
                                    <td>@include('hotel-management.partials.action-icons', ['showUrl' => route('hotel.services.show', ['recordId' => 3]), 'editUrl' => route('hotel.services.edit', ['recordId' => 3]), 'showDelete' => true])</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
