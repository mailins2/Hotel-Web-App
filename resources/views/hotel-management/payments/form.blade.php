...
>
    ...
    <div class="form-group col-md-6"><label class="form-label">Loại thanh toán</label><select class="form-select"><option>Thanh toán tiền phòng</option><option>Thanh toán trả phòng</option></select></div>
</x-hotel-management.form-page>
